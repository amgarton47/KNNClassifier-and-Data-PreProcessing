...
public class CrossValidationSet {
	...
	/**
	 * Retrieve a split from the data set. Splits start at 0. The split can either
	 * be a new copy of the data or a shared version. The shared version is more
	 * memory efficient, but can cause confusion/problems if you mutate the
	 * examples. The new copy avoids this, but is more memory intensive.
	 * 
